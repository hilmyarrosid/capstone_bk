...
?>
    ...
    <div class="container">
        <table border="0" style="width: 69%;">
            <tr>
                <td colspan="2">
                    <p class="header-text">Buat Akun</p>
                    <p class="sub-text">Sekarang Buat Akun Anda.</p>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="label-td" colspan="2">
                    <label for="tele" class="form-label">No Telpon: </label>
                </td>
            </tr>
            <tr>
                <td class="label-td" colspan="2">
                    <input type="tel" name="tele" class="input-text"  placeholder="ex: 085876450966" pattern="[0-9]{12}" >
                </td>
            </tr>
            <tr>
                <td class="label-td" colspan="2">
