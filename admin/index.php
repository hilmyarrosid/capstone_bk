                        ...
                        <tr >
                            ...
                            <td colspan="2" class="nav-bar" >
                                ...
                                <form action="doctors.php" method="post" class="header-search">
                                    ...
                                    <input type="search" name="search" class="input-text header-searchbar" placeholder="Cari Nama Dokter atauz" list="doctors">&nbsp;&nbsp;
                        ...
                        <table width="100%" border="0" class="dashbord-tables">
                            <tr>
                                ...
                                <p style="padding:10px;padding-left:48px;padding-bottom:0;font-size:23px;font-weight:700;color:var(--primarycolor);">
                                            Janji Temu Mendatang hingga <?php  
                                                ...
                                                echo $dayTranslations[$nextWeekDay] . ' depan';
                                            ?>
                                        </p>
                                    <p style="padding-bottom:19px;padding-left:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                                        Berikut Akses Cepat ke Janji Temu Mendatang hingga 7 hari ke depan.<br>
                                        Informasi lebih lanjut dapat ditemukan di bagian @Janji Temu.
                                    </p>

                                </td>
                                <td>
                                        <p style="padding:10px;padding-left:48px;padding-bottom:0;font-size:23px;font-weight:700;color:var(--primarycolor);">
                                            Sesi Mendatang hingga <?php  
                                                $dayTranslations = array(
                                                    'Sunday' => 'Minggu',
                                                    'Monday' => 'Senin',
                                                    'Tuesday' => 'Selasa',
                                    ...
                                    <p style="padding-bottom:19px;text-align:right;padding-right:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                                        Berikut Akses Cepat ke Sesi Mendatang hingga 7 hari ke depan.<br>
                                        Informasi lebih lanjut dapat ditemukan di bagian @Jadwal.
                                    </p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a href="schedule.php" class="non-style-link"><button class="btn-primary btn" style="width:85%">Tampilkan Semua Janji Temu</button></a>
                                    </center>
                                </td>
                            </tr>
                        </table>
